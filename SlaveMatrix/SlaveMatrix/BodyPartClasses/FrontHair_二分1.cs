...
{
    public class FrontHair_二分1 : FrontHair
    {
    	...
    	public FrontHair_二分1(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_二分1D e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "二分1";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][6]));
