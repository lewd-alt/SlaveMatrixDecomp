...
{
    public class FrontHair_ジグ : FrontHair
    {
    	...
    	public FrontHair_ジグ(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_ジグD e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "ジグ";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][0]));
