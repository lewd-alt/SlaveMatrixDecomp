...
{
    public class FrontHair_三分1 : FrontHair
    {
    	...
    	public double 髪長
    	{
    		set
    		{
    			...
    			X0Y0_髪左6.SetSizeYBase(X0Y0_髪左6.GetSizeYBase() * num);
    			X0Y0_髪頭頂横右1.SetSizeYBase(X0Y0_髪頭頂横右1.GetSizeYBase() * num);
    			X0Y0_髪頭頂横右2.SetSizeYBase(X0Y0_髪頭頂横右2.GetSizeYBase() * num);
    		}
    	}

    	public FrontHair_三分1(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_三分1D e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "三分1";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][7]));
    		...
    		X0Y0_髪左6CP = new ColorP(X0Y0_髪左6, 髪左6CD, DisUnit, abj: false);
    	...
    	private void 配色N0(BodyColorSet 体配色)
    	{
    		...
    		髪左6CD = new ColorD(ref 体配色.髪線, ref 体配色.髪O);
