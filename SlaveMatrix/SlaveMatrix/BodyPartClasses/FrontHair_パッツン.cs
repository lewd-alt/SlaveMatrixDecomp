...
{
    public class FrontHair_パッツン : FrontHair
    {
    	...
    	public FrontHair_パッツン(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_パッツンD e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "パッツン";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][4]));
