...
{
    public class FrontHair_ジグ中寄 : FrontHair
    {
    	...
    	public FrontHair_ジグ中寄(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_ジグ中寄D e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "ジグ中寄";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][1]));
