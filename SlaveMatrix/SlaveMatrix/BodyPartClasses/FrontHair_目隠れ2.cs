...
{
    public class FrontHair_目隠れ2 : FrontHair
    {
    	...
    	public FrontHair_目隠れ2(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_目隠れ2D e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "目隠れ2";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][18]));
