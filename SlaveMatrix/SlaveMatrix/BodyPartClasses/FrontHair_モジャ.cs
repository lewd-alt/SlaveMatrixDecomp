...
{
    public class FrontHair_モジャ : FrontHair
    {
    	...
    	public FrontHair_モジャ(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_モジャD e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "モジャ";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][3]));
