    ...
    public class 縦瞼 : Element
    {
    	...
    	public double 外線
    	{
    		set
    		{
    			...
    			X0Y0_瞼左_瞼.SetPenWidth(X0Y0_瞼左_瞼.GetPenWidth() * num);
    			...
    			X0Y3_瞼左_瞼.SetPenWidth(X0Y3_瞼左_瞼.GetPenWidth() * num);
    	...
    	public 縦瞼(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, 縦瞼D e)
    	{
    		ThisType = GetType();
    		Body = new VariantGrid(GlobalState.胴体["ForeheadEyelid"]);
