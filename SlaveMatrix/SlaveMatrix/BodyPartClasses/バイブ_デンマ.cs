...
public class バイブ_デンマ : Ele
{
	...
	public ColorD ヘッド線1CD;

	public ColorD ヘッド線2CD;

	public ColorD ヘッド線3CD;

	public ColorD ヘッド線4CD;

	public ColorD 拡張ユニットCD;

	public ColorD 拡張ユニット色CD;
	...
	public ColorP X0Y0_ヘッド線1CP;

	public ColorP X0Y0_ヘッド線2CP;

	public ColorP X0Y0_ヘッド線3CP;

	public ColorP X0Y0_ヘッド線4CP;

	public ColorP X0Y0_拡張ユニットCP;

	public ColorP X0Y0_拡張ユニット色CP;
	...
	public ColorP X0Y1_ヘッド線1CP;

	public ColorP X0Y1_ヘッド線2CP;

	public ColorP X0Y1_ヘッド線3CP;

	public ColorP X0Y1_ヘッド線4CP;

	public ColorP X0Y1_拡張ユニットCP;

	public ColorP X0Y1_拡張ユニット色CP;
	...
	public ColorP X0Y2_ヘッド線1CP;

	public ColorP X0Y2_ヘッド線2CP;

	public ColorP X0Y2_ヘッド線3CP;

	public ColorP X0Y2_拡張ユニットCP;

	public ColorP X0Y2_拡張ユニット色CP;
	...
	public ColorP X0Y3_ヘッド線1CP;

	public ColorP X0Y3_ヘッド線2CP;

	public ColorP X0Y3_拡張ユニットCP;

	public ColorP X0Y3_拡張ユニット色CP;
	...
	public ColorP X0Y4_ヘッド線CP;

	public ColorP X0Y4_拡張ユニットCP;

	public ColorP X0Y4_拡張ユニット色CP;
	...
	public bool ヘッド線1_表示
	{
		get
		{
			return X0Y0_ヘッド線1.Dra;
		}
		set
		{
			X0Y0_ヘッド線1.Dra = value;
			X0Y1_ヘッド線1.Dra = value;
			X0Y2_ヘッド線1.Dra = value;
			X0Y3_ヘッド線1.Dra = value;
			X0Y0_ヘッド線1.Hit = value;
			X0Y1_ヘッド線1.Hit = value;
			X0Y2_ヘッド線1.Hit = value;
			X0Y3_ヘッド線1.Hit = value;
		}
	}

	public bool ヘッド線2_表示
	{
		get
		{
			return X0Y0_ヘッド線2.Dra;
		}
		set
		{
			X0Y0_ヘッド線2.Dra = value;
			X0Y1_ヘッド線2.Dra = value;
			X0Y2_ヘッド線2.Dra = value;
			X0Y3_ヘッド線2.Dra = value;
			X0Y0_ヘッド線2.Hit = value;
			X0Y1_ヘッド線2.Hit = value;
			X0Y2_ヘッド線2.Hit = value;
			X0Y3_ヘッド線2.Hit = value;
		}
	}

	public bool ヘッド線3_表示
	{
		get
		{
			return X0Y0_ヘッド線3.Dra;
		}
		set
		{
			X0Y0_ヘッド線3.Dra = value;
			X0Y1_ヘッド線3.Dra = value;
			X0Y2_ヘッド線3.Dra = value;
			X0Y0_ヘッド線3.Hit = value;
			X0Y1_ヘッド線3.Hit = value;
			X0Y2_ヘッド線3.Hit = value;
		}
	}

	public bool ヘッド線4_表示
	{
		get
		{
			return X0Y0_ヘッド線4.Dra;
		}
		set
		{
			X0Y0_ヘッド線4.Dra = value;
			X0Y1_ヘッド線4.Dra = value;
			X0Y0_ヘッド線4.Hit = value;
			X0Y1_ヘッド線4.Hit = value;
		}
	}

	public bool 拡張ユニット_表示
	{
		get
		{
			return X0Y0_拡張ユニット.Dra;
		}
		set
		{
			X0Y0_拡張ユニット.Dra = value;
			X0Y1_拡張ユニット.Dra = value;
			X0Y2_拡張ユニット.Dra = value;
			X0Y3_拡張ユニット.Dra = value;
			X0Y4_拡張ユニット.Dra = value;
			X0Y0_拡張ユニット.Hit = value;
			X0Y1_拡張ユニット.Hit = value;
			X0Y2_拡張ユニット.Hit = value;
			X0Y3_拡張ユニット.Hit = value;
			X0Y4_拡張ユニット.Hit = value;
		}
	}

	public bool 拡張ユニット色_表示
	{
		get
		{
			return X0Y0_拡張ユニット色.Dra;
		}
		set
		{
			X0Y0_拡張ユニット色.Dra = value;
			X0Y1_拡張ユニット色.Dra = value;
			X0Y2_拡張ユニット色.Dra = value;
			X0Y3_拡張ユニット色.Dra = value;
			X0Y4_拡張ユニット色.Dra = value;
			X0Y0_拡張ユニット色.Hit = value;
			X0Y1_拡張ユニット色.Hit = value;
			X0Y2_拡張ユニット色.Hit = value;
			X0Y3_拡張ユニット色.Hit = value;
			X0Y4_拡張ユニット色.Hit = value;
		}
	}
	...
	public バイブ_デンマ(double DisUnit, 配色指定 配色指定, 体配色 体配色, Med Med, バイブ_デンマD e)
	{
		...
		ヘッド線3_表示 = e.ヘッド線3_表示;
		ヘッド線4_表示 = e.ヘッド線4_表示;
		拡張ユニット_表示 = e.拡張ユニット_表示;
		拡張ユニット色_表示 = e.拡張ユニット色_表示;
		...
		X0Y0_ヘッド線1CP = new ColorP(X0Y0_ヘッド線1, ヘッド線1CD, DisUnit, abj: true);
		X0Y0_ヘッド線2CP = new ColorP(X0Y0_ヘッド線2, ヘッド線2CD, DisUnit, abj: true);
		X0Y0_ヘッド線3CP = new ColorP(X0Y0_ヘッド線3, ヘッド線3CD, DisUnit, abj: true);
		X0Y0_ヘッド線4CP = new ColorP(X0Y0_ヘッド線4, ヘッド線4CD, DisUnit, abj: true);
		X0Y0_拡張ユニットCP = new ColorP(X0Y0_拡張ユニット, 拡張ユニットCD, DisUnit, abj: true);
		X0Y0_拡張ユニット色CP = new ColorP(X0Y0_拡張ユニット色, 拡張ユニット色CD, DisUnit, abj: true);
		...
		X0Y1_ヘッド線1CP = new ColorP(X0Y1_ヘッド線1, ヘッド線1CD, DisUnit, abj: true);
		X0Y1_ヘッド線2CP = new ColorP(X0Y1_ヘッド線2, ヘッド線2CD, DisUnit, abj: true);
		X0Y1_ヘッド線3CP = new ColorP(X0Y1_ヘッド線3, ヘッド線3CD, DisUnit, abj: true);
		X0Y1_ヘッド線4CP = new ColorP(X0Y1_ヘッド線4, ヘッド線4CD, DisUnit, abj: true);
		X0Y1_拡張ユニットCP = new ColorP(X0Y1_拡張ユニット, 拡張ユニットCD, DisUnit, abj: true);
		X0Y1_拡張ユニット色CP = new ColorP(X0Y1_拡張ユニット色, 拡張ユニット色CD, DisUnit, abj: true);
		...
		X0Y2_ヘッド線1CP = new ColorP(X0Y2_ヘッド線1, ヘッド線1CD, DisUnit, abj: true);
		X0Y2_ヘッド線2CP = new ColorP(X0Y2_ヘッド線2, ヘッド線2CD, DisUnit, abj: true);
		X0Y2_ヘッド線3CP = new ColorP(X0Y2_ヘッド線3, ヘッド線3CD, DisUnit, abj: true);
		X0Y2_拡張ユニットCP = new ColorP(X0Y2_拡張ユニット, 拡張ユニットCD, DisUnit, abj: true);
		X0Y2_拡張ユニット色CP = new ColorP(X0Y2_拡張ユニット色, 拡張ユニット色CD, DisUnit, abj: true);
		...
		X0Y3_ヘッド線1CP = new ColorP(X0Y3_ヘッド線1, ヘッド線1CD, DisUnit, abj: true);
		X0Y3_ヘッド線2CP = new ColorP(X0Y3_ヘッド線2, ヘッド線2CD, DisUnit, abj: true);
		X0Y3_拡張ユニットCP = new ColorP(X0Y3_拡張ユニット, 拡張ユニットCD, DisUnit, abj: true);
		X0Y3_拡張ユニット色CP = new ColorP(X0Y3_拡張ユニット色, 拡張ユニット色CD, DisUnit, abj: true);
		...
		X0Y4_ヘッド線CP = new ColorP(X0Y4_ヘッド線, ヘッド線1CD, DisUnit, abj: true);
		X0Y4_拡張ユニットCP = new ColorP(X0Y4_拡張ユニット, 拡張ユニットCD, DisUnit, abj: true);
		X0Y4_拡張ユニット色CP = new ColorP(X0Y4_拡張ユニット色, 拡張ユニット色CD, DisUnit, abj: true);
		...
		X0Y3_ユニット_ユニット.BasePointBase = X0Y3_ユニット_ユニット.ToLocal(X0Y3_ヘッド.ToGlobal(X0Y3_ヘッド.JP[1].Joint));
	...
	public override void 色更新()
	{
		...
		case 0:
			...
			X0Y0_ヘッド線3CP.Update();
			X0Y0_ヘッド線4CP.Update();
			X0Y0_拡張ユニットCP.Update();
			X0Y0_拡張ユニット色CP.Update();
		...
		case 1:
			...
			X0Y1_ヘッド線3CP.Update();
			X0Y1_ヘッド線4CP.Update();
			X0Y1_拡張ユニットCP.Update();
			X0Y1_拡張ユニット色CP.Update();
		...
		case 2:
			...
			X0Y2_ヘッド線2CP.Update();
			X0Y2_ヘッド線3CP.Update();
			X0Y2_拡張ユニットCP.Update();
			X0Y2_拡張ユニット色CP.Update();
		...
		case 3:
			...
			X0Y3_ヘッド線1CP.Update();
			X0Y3_ヘッド線2CP.Update();
			X0Y3_拡張ユニットCP.Update();
			X0Y3_拡張ユニット色CP.Update();
		...
		default:
			X0Y4_ヘッドCP.Update();
			X0Y4_ヘッド線CP.Update();
			X0Y4_拡張ユニットCP.Update();
			X0Y4_拡張ユニット色CP.Update();
