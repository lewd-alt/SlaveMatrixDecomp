...
namespace SlaveMatrix
{
    public class Anus_獣 : Anus
    {
    	...
    	public Anus_獣(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, Anus_獣D e)
    	{
    		Anus_獣 Anus_獣2 = this;
    		ThisType = GetType();
    		...
    		if (e.肛門精液_接続.Count > 0)
    		{
    			...
    			肛門精液_接続 = e.肛門精液_接続.Select(delegate(ElementData g)
    			{
    				...
    				f.Par = Anus_獣2;
    				f.ConnectionType = ConnectionInfo.Anus_獣_肛門精液_接続;
    				f.接続(Anus_獣2.肛門精液_接続点);
    				return f;
    			}).ToArray();
    		}
    		base.配色指定 = 配色指定;
    	...
    	private void 配色N0(BodyColorSet 体配色)
    	{
    		...
    		Anus3CD = new ColorD(ref ColorHelper.Empty, ref ret);
    		Anus2CD = new ColorD(ref 体配色.粘膜線, ref Anus3CD.c2);
