...
{
    public class FrontHair_中分け1 : FrontHair
    {
    	...
    	public FrontHair_中分け1(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_中分け1D e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "中分け1";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][10]));
