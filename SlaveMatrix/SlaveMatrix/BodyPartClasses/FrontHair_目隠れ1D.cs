...
{
    [Serializable]
    public class FrontHair_目隠れ1D : FrontHairData
    {
    	...
    	public bool 髪右6_表示 = true;

    	public bool 髪右7_表示 = true;
    	...
    	public FrontHair_目隠れ1D()
    	{
    		ThisType = GetType();
    	}

    	public FrontHair_目隠れ1D SetRandom()
    	{
    	...
    	{
    		return new FrontHair_目隠れ1(DisUnit, 配色指定, 体配色, Med, this);
    	}
    }
}
