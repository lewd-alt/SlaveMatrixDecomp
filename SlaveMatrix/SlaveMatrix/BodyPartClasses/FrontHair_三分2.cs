...
{
    public class FrontHair_三分2 : FrontHair
    {
    	...
    	public FrontHair_三分2(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_三分2D e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "三分2";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][9]));
