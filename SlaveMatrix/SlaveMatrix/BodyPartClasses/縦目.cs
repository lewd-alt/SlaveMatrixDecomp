...
namespace SlaveMatrix
{
    public class 縦目 : Element
    {
    	...
    	public 縦目(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, 縦目D e)
    	{
    		縦目 縦目2 = this;
    		ThisType = GetType();
    		...
    		if (e.瞼_接続.Count > 0)
    		{
    			...
    			瞼_接続 = e.瞼_接続.Select(delegate(ElementData g)
    			{
    				...
    				f.Par = 縦目2;
    				f.ConnectionType = ConnectionInfo.縦目_瞼_接続;
    				f.接続(縦目2.瞼_接続点);
    				return f;
    			}).ToArray();
    		}
    	...
    	private void 配色N0(BodyColorSet 体配色)
    	{
    		...
    		黒目_黒目CD = new ColorD(ref ColorHelper.Black, ref 体配色.縦目O);
