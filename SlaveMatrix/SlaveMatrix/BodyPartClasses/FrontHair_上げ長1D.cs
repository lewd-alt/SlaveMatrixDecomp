...
{
    [Serializable]
    public class FrontHair_上げ長1D : FrontHairData
    {
    	...
    	public bool 髪左根1_表示 = true;

    	public bool 髪左根2_表示 = true;

    	public bool 髪左3_表示 = true;

    	public bool 髪左4_表示 = true;

    	public bool 髪右根1_表示 = true;

    	public bool 髪右根2_表示 = true;
    	...
    	public FrontHair_上げ長1D()
    	{
    		ThisType = GetType();
    	}

    	public FrontHair_上げ長1D SetRandom()
    	{
    	...
    	{
    		return new FrontHair_上げ長1(DisUnit, 配色指定, 体配色, Med, this);
    	}
    }
}
