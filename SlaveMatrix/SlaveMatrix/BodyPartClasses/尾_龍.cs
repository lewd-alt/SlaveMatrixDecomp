...
namespace SlaveMatrix
{
    public class 尾_龍 : 尾
    {
    	...
    	public 尾_龍(double DisUnit, 配色指定 配色指定, 体配色 体配色, Med Med, 尾_龍D e)
    	{
    		...
    		X0Y0_尾37 = pars["尾37"].ToPar();
    		X0Y0_尾36 = pars["尾36"].ToPar();
    		X0Y0_尾35 = pars["尾35"].ToPar();
    		X0Y0_尾34 = pars["尾34"].ToPar();
    		X0Y0_尾33 = pars["尾33"].ToPar();
    		X0Y0_尾32 = pars["尾32"].ToPar();
    		X0Y0_尾31 = pars["尾31"].ToPar();
    		X0Y0_尾30 = pars["尾30"].ToPar();
    		X0Y0_尾29 = pars["尾29"].ToPar();
    		X0Y0_尾28 = pars["尾28"].ToPar();
    		X0Y0_尾27 = pars["尾27"].ToPar();
    		X0Y0_尾26 = pars["尾26"].ToPar();
    		X0Y0_尾25 = pars["尾25"].ToPar();
    		X0Y0_尾24 = pars["尾24"].ToPar();
    		X0Y0_尾23 = pars["尾23"].ToPar();
    		X0Y0_尾22 = pars["尾22"].ToPar();
    		X0Y0_尾21 = pars["尾21"].ToPar();
    		X0Y0_尾20 = pars["尾20"].ToPar();
    		X0Y0_尾19 = pars["尾19"].ToPar();
    		...
    		base.配色指定 = 配色指定;
    		配色(体配色);
    		X0Y0_尾40CP = new ColorP(X0Y0_尾40, 尾40CD, DisUnit, abj: true);
    		X0Y0_尾39CP = new ColorP(X0Y0_尾39, 尾39CD, DisUnit, abj: true);
    		X0Y0_尾38CP = new ColorP(X0Y0_尾38, 尾38CD, DisUnit, abj: true);
    		X0Y0_尾37CP = new ColorP(X0Y0_尾37, 尾37CD, DisUnit, abj: true);
    		X0Y0_尾36CP = new ColorP(X0Y0_尾36, 尾36CD, DisUnit, abj: true);
    		X0Y0_尾35CP = new ColorP(X0Y0_尾35, 尾35CD, DisUnit, abj: true);
    		X0Y0_尾34CP = new ColorP(X0Y0_尾34, 尾34CD, DisUnit, abj: true);
    		X0Y0_尾33CP = new ColorP(X0Y0_尾33, 尾33CD, DisUnit, abj: true);
    		X0Y0_尾32CP = new ColorP(X0Y0_尾32, 尾32CD, DisUnit, abj: true);
    		X0Y0_尾31CP = new ColorP(X0Y0_尾31, 尾31CD, DisUnit, abj: true);
    		X0Y0_尾30CP = new ColorP(X0Y0_尾30, 尾30CD, DisUnit, abj: true);
    		X0Y0_尾29CP = new ColorP(X0Y0_尾29, 尾29CD, DisUnit, abj: true);
    		X0Y0_尾28CP = new ColorP(X0Y0_尾28, 尾28CD, DisUnit, abj: true);
    		X0Y0_尾27CP = new ColorP(X0Y0_尾27, 尾27CD, DisUnit, abj: true);
    		X0Y0_尾26CP = new ColorP(X0Y0_尾26, 尾26CD, DisUnit, abj: true);
    		X0Y0_尾25CP = new ColorP(X0Y0_尾25, 尾25CD, DisUnit, abj: true);
    		X0Y0_尾24CP = new ColorP(X0Y0_尾24, 尾24CD, DisUnit, abj: true);
    		X0Y0_尾23CP = new ColorP(X0Y0_尾23, 尾23CD, DisUnit, abj: true);
    		X0Y0_尾22CP = new ColorP(X0Y0_尾22, 尾22CD, DisUnit, abj: true);
    		X0Y0_尾21CP = new ColorP(X0Y0_尾21, 尾21CD, DisUnit, abj: true);
    		X0Y0_尾20CP = new ColorP(X0Y0_尾20, 尾20CD, DisUnit, abj: true);
    		X0Y0_尾19CP = new ColorP(X0Y0_尾19, 尾19CD, DisUnit, abj: true);
    	...
    	public override void SetAngle0()
    	{
    		...
    		X0Y0_尾40.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾39.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾38.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾37.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾36.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾35.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾34.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾33.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾32.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾31.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾30.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾29.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾28.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾27.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾26.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾25.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾24.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾23.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾22.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾21.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾20.AngleBase = maxAngle.GetRanAngle();
    		X0Y0_尾19.AngleBase = maxAngle.GetRanAngle();
    	...
    	public override IEnumerable<Par> Enum軸()
    	{
    		...
    		yield return X0Y0_尾19;
    		yield return X0Y0_尾20;
    		yield return X0Y0_尾21;
    		yield return X0Y0_尾22;
    		yield return X0Y0_尾23;
    		yield return X0Y0_尾24;
    		yield return X0Y0_尾25;
    		yield return X0Y0_尾26;
    		yield return X0Y0_尾27;
    		yield return X0Y0_尾28;
    		yield return X0Y0_尾29;
    		yield return X0Y0_尾30;
    		yield return X0Y0_尾31;
    		yield return X0Y0_尾32;
    		yield return X0Y0_尾33;
    		yield return X0Y0_尾34;
    		yield return X0Y0_尾35;
    		yield return X0Y0_尾36;
    		yield return X0Y0_尾37;
    		yield return X0Y0_尾38;
    		yield return X0Y0_尾39;
    		yield return X0Y0_尾40;
    	}
    	...
    	{
    		尾40CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾39CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾38CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾37CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾36CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾35CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾34CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾33CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾32CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾31CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾30CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾29CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾28CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾27CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾26CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾25CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾24CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾23CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾22CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾21CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾20CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾19CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
    		尾18CD = new ColorD(ref Col.Black, ref 体配色.鱗0R);
