...
public class 触覚_線 : 触覚
{
	...
	public 触覚_線(double DisUnit, 配色指定 配色指定, 体配色 体配色, Med Med, 触覚_線D e)
	{
		...
		X0Y0_節11CP = new ColorP(X0Y0_節11, 節11CD, DisUnit, abj: true);
		X0Y0_節12CP = new ColorP(X0Y0_節12, 節12CD, DisUnit, abj: true);
		X0Y0_節13CP = new ColorP(X0Y0_節13, 節13CD, DisUnit, abj: true);
		X0Y0_節14CP = new ColorP(X0Y0_節14, 節14CD, DisUnit, abj: true);
		X0Y0_節15CP = new ColorP(X0Y0_節15, 節15CD, DisUnit, abj: true);
		X0Y0_節16CP = new ColorP(X0Y0_節16, 節16CD, DisUnit, abj: true);
		X0Y0_節17CP = new ColorP(X0Y0_節17, 節17CD, DisUnit, abj: true);
		X0Y0_節18CP = new ColorP(X0Y0_節18, 節18CD, DisUnit, abj: true);
		X0Y0_節19CP = new ColorP(X0Y0_節19, 節19CD, DisUnit, abj: true);
		X0Y0_節20CP = new ColorP(X0Y0_節20, 節20CD, DisUnit, abj: true);
		X0Y0_節21CP = new ColorP(X0Y0_節21, 節21CD, DisUnit, abj: true);
		X0Y0_節22CP = new ColorP(X0Y0_節22, 節22CD, DisUnit, abj: true);
		X0Y0_節23CP = new ColorP(X0Y0_節23, 節23CD, DisUnit, abj: true);
		...
		X0Y0_節27CP = new ColorP(X0Y0_節27, 節27CD, DisUnit, abj: true);
		X0Y0_節28CP = new ColorP(X0Y0_節28, 節28CD, DisUnit, abj: true);
		X0Y0_節29CP = new ColorP(X0Y0_節29, 節29CD, DisUnit, abj: true);
		X0Y0_節30CP = new ColorP(X0Y0_節30, 節30CD, DisUnit, abj: true);
		X0Y0_節31CP = new ColorP(X0Y0_節31, 節31CD, DisUnit, abj: true);
		X0Y0_節32CP = new ColorP(X0Y0_節32, 節32CD, DisUnit, abj: true);
		X0Y0_節33CP = new ColorP(X0Y0_節33, 節33CD, DisUnit, abj: true);
		X0Y0_節34CP = new ColorP(X0Y0_節34, 節34CD, DisUnit, abj: true);
		X0Y0_節35CP = new ColorP(X0Y0_節35, 節35CD, DisUnit, abj: true);
		X0Y0_節36CP = new ColorP(X0Y0_節36, 節36CD, DisUnit, abj: true);
		X0Y0_節37CP = new ColorP(X0Y0_節37, 節37CD, DisUnit, abj: true);
		X0Y0_節38CP = new ColorP(X0Y0_節38, 節38CD, DisUnit, abj: true);
		X0Y0_節39CP = new ColorP(X0Y0_節39, 節39CD, DisUnit, abj: true);
		X0Y0_節40CP = new ColorP(X0Y0_節40, 節40CD, DisUnit, abj: true);
		X0Y0_節41CP = new ColorP(X0Y0_節41, 節41CD, DisUnit, abj: true);
		X0Y0_節42CP = new ColorP(X0Y0_節42, 節42CD, DisUnit, abj: true);
		X0Y0_節43CP = new ColorP(X0Y0_節43, 節43CD, DisUnit, abj: true);
		X0Y0_節44CP = new ColorP(X0Y0_節44, 節44CD, DisUnit, abj: true);
		X0Y0_節45CP = new ColorP(X0Y0_節45, 節45CD, DisUnit, abj: true);
		X0Y0_節46CP = new ColorP(X0Y0_節46, 節46CD, DisUnit, abj: true);
		X0Y0_節47CP = new ColorP(X0Y0_節47, 節47CD, DisUnit, abj: true);
		X0Y0_節48CP = new ColorP(X0Y0_節48, 節48CD, DisUnit, abj: true);
		X0Y0_節49CP = new ColorP(X0Y0_節49, 節49CD, DisUnit, abj: true);
		X0Y0_節50CP = new ColorP(X0Y0_節50, 節50CD, DisUnit, abj: true);
		X0Y0_節51CP = new ColorP(X0Y0_節51, 節51CD, DisUnit, abj: true);
		X0Y0_節52CP = new ColorP(X0Y0_節52, 節52CD, DisUnit, abj: true);
		X0Y0_節53CP = new ColorP(X0Y0_節53, 節53CD, DisUnit, abj: true);
		X0Y0_節54CP = new ColorP(X0Y0_節54, 節54CD, DisUnit, abj: true);
		X0Y0_節55CP = new ColorP(X0Y0_節55, 節55CD, DisUnit, abj: true);
		X0Y0_節56CP = new ColorP(X0Y0_節56, 節56CD, DisUnit, abj: true);
		X0Y0_節57CP = new ColorP(X0Y0_節57, 節57CD, DisUnit, abj: true);
		X0Y0_節58CP = new ColorP(X0Y0_節58, 節58CD, DisUnit, abj: true);
		X0Y0_節59CP = new ColorP(X0Y0_節59, 節59CD, DisUnit, abj: true);
		X0Y0_節60CP = new ColorP(X0Y0_節60, 節60CD, DisUnit, abj: true);
		濃度 = e.濃度;
	}
	...
	public override void SetAngle0()
	{
		...
		double num3 = 1.0;
		double num4 = 0.01;
		X0Y0_節1.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		...
		num3 -= num4;
		X0Y0_節11.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節12.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節13.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節14.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節15.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節16.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節17.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節18.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節19.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節20.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節21.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節22.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節23.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節24.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節25.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節26.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節27.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節28.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節29.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節30.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節31.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節32.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節33.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節34.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節35.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節36.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節37.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節38.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節39.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節40.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節41.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節42.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節43.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節44.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節45.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節46.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節47.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節48.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節49.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節50.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節51.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節52.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節53.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節54.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節55.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節56.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節57.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節58.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節59.AngleBase = num * (double)num2 * num3;
		num3 -= num4;
		X0Y0_節60.AngleBase = num * (double)num2 * num3;
		本体.JoinPAall();
	}
	...
	public override IEnumerable<Par> Enum軸()
	{
		...
		yield return X0Y0_節11;
		yield return X0Y0_節12;
		yield return X0Y0_節13;
		yield return X0Y0_節14;
		yield return X0Y0_節15;
		yield return X0Y0_節16;
		yield return X0Y0_節17;
		yield return X0Y0_節18;
		yield return X0Y0_節19;
		yield return X0Y0_節20;
		yield return X0Y0_節21;
		yield return X0Y0_節22;
		yield return X0Y0_節23;
		yield return X0Y0_節24;
		yield return X0Y0_節25;
		yield return X0Y0_節26;
		yield return X0Y0_節27;
		yield return X0Y0_節28;
		yield return X0Y0_節29;
		yield return X0Y0_節30;
		yield return X0Y0_節31;
		yield return X0Y0_節32;
		yield return X0Y0_節33;
		yield return X0Y0_節34;
		yield return X0Y0_節35;
		yield return X0Y0_節36;
		yield return X0Y0_節37;
		yield return X0Y0_節38;
		yield return X0Y0_節39;
		yield return X0Y0_節40;
		yield return X0Y0_節41;
		yield return X0Y0_節42;
		yield return X0Y0_節43;
		yield return X0Y0_節44;
		yield return X0Y0_節45;
		yield return X0Y0_節46;
		yield return X0Y0_節47;
		yield return X0Y0_節48;
		yield return X0Y0_節49;
		yield return X0Y0_節50;
		yield return X0Y0_節51;
		yield return X0Y0_節52;
		yield return X0Y0_節53;
		yield return X0Y0_節54;
		yield return X0Y0_節55;
		yield return X0Y0_節56;
		yield return X0Y0_節57;
		yield return X0Y0_節58;
		yield return X0Y0_節59;
		yield return X0Y0_節60;
	}
