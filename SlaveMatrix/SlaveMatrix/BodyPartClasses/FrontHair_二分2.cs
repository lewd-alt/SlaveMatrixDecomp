...
{
    public class FrontHair_二分2 : FrontHair
    {
    	...
    	public FrontHair_二分2(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_二分2D e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "二分2";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][8]));
