...
namespace SlaveMatrix
{
    public class 後髪0_編1パツ : お下げ1
    {
    	...
    	public bool お下げ_編節8_髪節_表示
    	{
    		get
    		{
    			return X0Y0_お下げ_編節8_髪節.Dra;
    		}
    		set
    		{
    			X0Y0_お下げ_編節8_髪節.Dra = value;
    			X0Y0_お下げ_編節8_髪節.Hit = value;
    		}
    	}
    	...
    	public bool お下げ_編節8_髪編目_表示
    	{
    		get
    		{
    			return X0Y0_お下げ_編節8_髪編目.Dra;
    		}
    		set
    		{
    			X0Y0_お下げ_編節8_髪編目.Dra = value;
    			X0Y0_お下げ_編節8_髪編目.Hit = value;
    		}
    	}
    	...
    	public override double 濃度
    	{
    		...
    		set
    		{
    			...
    			お下げ_編節8_髪節CD.不透明度 = value;
    			お下げ_編節8_髪編目CD.不透明度 = value;
    	...
    	public 後髪0_編1パツ(double DisUnit, 配色指定 配色指定, 体配色 体配色, Med Med, 後髪0_編1パツD e)
    	{
    		...
    		X0Y0_お下げ_編節8_髪節 = pars3["髪節"].ToPar();
    		X0Y0_お下げ_編節8_髪編目 = pars3["髪編目"].ToPar();
    		...
    		お下げ_編節8_髪節_表示 = e.お下げ_編節8_髪節_表示;
    		お下げ_編節8_髪編目_表示 = e.お下げ_編節8_髪編目_表示;
    		...
    		X0Y0_お下げ_編節8_髪節CP = new ColorP(X0Y0_お下げ_編節8_髪節, お下げ_編節8_髪節CD, DisUnit, abj: false);
    		X0Y0_お下げ_編節8_髪編目CP = new ColorP(X0Y0_お下げ_編節8_髪編目, お下げ_編節8_髪編目CD, DisUnit, abj: false);
    	...
    	public override void 色更新()
    	{
    		...
    		X0Y0_お下げ_編節8_髪節CP.Update();
    		X0Y0_お下げ_編節8_髪編目CP.Update();
    	...
    	private void 配色N0(体配色 体配色)
    	{
    		...
    		お下げ_編節8_髪節CD = new ColorD(ref 体配色.髪線, ref 体配色.髪O);
    		お下げ_編節8_髪編目CD = new ColorD(ref 体配色.髪線, ref 体配色.髪O);
