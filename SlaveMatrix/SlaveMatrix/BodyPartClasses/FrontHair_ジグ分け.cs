...
{
    public class FrontHair_ジグ分け : FrontHair
    {
    	...
    	public FrontHair_ジグ分け(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_ジグ分けD e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "ジグ分け";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][2]));
