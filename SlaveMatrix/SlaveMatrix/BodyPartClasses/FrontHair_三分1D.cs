...
{
    [Serializable]
    public class FrontHair_三分1D : FrontHairData
    {
    	...
    	public FrontHair_三分1D()
    	{
    		ThisType = GetType();
    	}

    	public FrontHair_三分1D SetRandom()
    	{
    	...
    	{
    		return new FrontHair_三分1(DisUnit, 配色指定, 体配色, Med, this);
    	}
    }
}
