...
{
    public class Blindfold : Element
    {
    	...
    	public Blindfold(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, BlindfoldD e)
    	{
    		ThisType = GetType();
    		Body = new VariantGrid(GlobalState.胴体["Blindfold"]);
