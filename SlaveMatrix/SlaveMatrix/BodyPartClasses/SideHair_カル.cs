...
namespace SlaveMatrix
{
    public class SideHair_カル : SideHair
    {
    	...
    	public SideHair_カル(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, SideHair_カルD e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "カル";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["SideHairLeft"][0][3]));
