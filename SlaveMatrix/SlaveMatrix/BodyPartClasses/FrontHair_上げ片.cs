...
{
    public class FrontHair_上げ片 : FrontHair
    {
    	...
    	public FrontHair_上げ片(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_上げ片D e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "上げ片";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][16]));
