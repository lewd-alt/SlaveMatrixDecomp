...
{
    public class FrontHair_上げ長2 : FrontHair
    {
    	...
    	public FrontHair_上げ長2(double DisUnit, 配色指定 配色指定, BodyColorSet 体配色, ModeEventDispatcher Med, FrontHair_上げ長2D e)
    	{
    		ThisType = GetType();
    		MorphVariant morphVariant = new MorphVariant();
    		morphVariant.Tag = "上げ長2";
    		morphVariant.Add(new PartGroup(GlobalState.胴体["FrontHair"][0][15]));
