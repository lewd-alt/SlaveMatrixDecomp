...
public class 口_裂け : 口
{
	...
	public 口_裂け(double DisUnit, 配色指定 配色指定, 体配色 体配色, Med Med, 口_裂けD e)
	{
		...
		base.配色指定 = 配色指定;
		配色(体配色);
		X0Y0_口CP = new ColorP(X0Y0_口, 歯CD, DisUnit, abj: true);
		X0Y0_歯CP = new ColorP(X0Y0_歯, 口CD, DisUnit, abj: true);
		...
		X0Y1_口CP = new ColorP(X0Y1_口, 歯CD, DisUnit, abj: true);
		X0Y1_歯CP = new ColorP(X0Y1_歯, 口CD, DisUnit, abj: true);
		...
		X0Y4_口CP = new ColorP(X0Y4_口, 歯CD, DisUnit, abj: true);
		...
		X0Y5_口CP = new ColorP(X0Y5_口, 歯CD, DisUnit, abj: true);
		X0Y5_歯CP = new ColorP(X0Y5_歯, 口CD, DisUnit, abj: true);
		...
		X0Y6_口CP = new ColorP(X0Y6_口, 歯CD, DisUnit, abj: true);
		X0Y6_歯CP = new ColorP(X0Y6_歯, 口CD, DisUnit, abj: true);
		...
		X0Y9_口CP = new ColorP(X0Y9_口, 歯CD, DisUnit, abj: true);
		X0Y9_歯CP = new ColorP(X0Y9_歯, 口CD, DisUnit, abj: true);
		...
		X0Y10_口CP = new ColorP(X0Y10_口, 歯CD, DisUnit, abj: true);
		...
		X0Y11_口CP = new ColorP(X0Y11_口, 歯CD, DisUnit, abj: true);
		...
		X0Y12_口CP = new ColorP(X0Y12_口, 歯CD, DisUnit, abj: true);
		X0Y12_歯CP = new ColorP(X0Y12_歯, 口CD, DisUnit, abj: true);
		...
		X0Y13_口CP = new ColorP(X0Y13_口, 歯CD, DisUnit, abj: true);
